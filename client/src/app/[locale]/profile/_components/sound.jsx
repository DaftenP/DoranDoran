...
export default function Sound() {
  ...
  return (
    <>
      <p className="text-xl md:text-5xl pb-2">{t("sound")}</p>
      <div className="border-2 border-[#B0BEC5] bg-[#FFF5E1] w-[90%] h-[30%] rounded-3xl flex items-center flex-col">
        ...
        <div className="w-[90%] h-1/3 flex items-center justify-between">
          <div className="h-full flex flex-col">
            ...
            <div className="border-2 border-[#FFE4B5] bg-[#FFFBF2] w-[175%] h-[50%] rounded-full"></div>
          </div>
        ...
        <div className="w-[90%] h-1/3 flex items-center justify-between">
          <div className="h-full flex flex-col">
            ...
            <div className="border-2 border-[#FFE4B5] bg-[#FFFBF2] w-[610%] h-[50%] rounded-full"></div>
          </div>
          <p className="md:text-3xl">50%</p>
        </div>
        {/* sound effects */}
        <div className="w-[90%] h-1/3 flex items-center justify-between">
          <div className="h-full flex flex-col">
            ...
            <div className="border-2 border-[#FFE4B5] bg-[#FFFBF2] w-[230%] h-[50%] rounded-full"></div>
          </div>
          <p className="md:text-3xl">50%</p>
        </div>
      </div>
